...
class MockTrainer(BaseTrainer):
    ...
    def train_epoch(self, epoch): return 0.0
    def validate(self, epoch): return 0.0
    def _train_step(self, batch): return 0.0
    def _val_step(self, batch): return 0.0
    def _get_extra_checkpoint_data(self) -> Dict[str, Any]: return {}
...
def test_best_checkpoint_selection():
    ...
    assert is_best == False, "Lower PCK should NOT be is_best"
