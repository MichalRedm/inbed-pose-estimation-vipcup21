...
import os
import pytest
from src.models import build_model, register_model
from src.models.__init__ import load_model_for_inference
import src.models.hrnet  # Ensure registration
...
def test_legacy_remapping_logic():
    ...
    old_state = {
        ...
        "stage2.modules_list.0.fusion.fuse_layers.0.1.0.weight": torch.randn(32, 64, 1, 1),
    ...
    try:
        ...
        assert torch.allclose(current_state["model.stage2.0.branches.0.0.conv1.weight"], old_state["stage2.modules_list.0.branches.0.0.conv1.weight"])
        
        # Check mapping: fusion.fuse_layers -> fuse_layers.layers
        assert torch.allclose(current_state["model.stage2.0.fuse_layers.layers.0.1.0.weight"], old_state["stage2.modules_list.0.fusion.fuse_layers.0.1.0.weight"])
...
def test_coordinate_model_passthrough():
    ...
    class MockCoordModel(nn.Module):
        ...
        @property
        def output_type(self): return "coordinates"
