...
| 54 | Self-Training (EMA Teacher + CUT Strong Aug) | SUCCESS | **78.1%** | **v2 Run**: Successfully leveraged subjects 31-80 as unlabeled data. Achieved stable performance; proven consistent regularization. |
