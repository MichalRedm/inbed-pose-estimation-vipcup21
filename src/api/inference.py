...
class InferenceService:
    ...
    def load_model(self, checkpoint_path: str, force_reload: bool = False):
        ...
        self._model = load_model_for_inference(checkpoint_path, self._device, config=config)
    ...
    @torch.no_grad()
    def predict(self, image_tensor: torch.Tensor, decode_method: str = "argmax") -> torch.Tensor:
        """
