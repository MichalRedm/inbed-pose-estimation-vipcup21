...
def main():
    ...
    parser.add_argument("--run_id", type=str, required=True, help="Run ID of the trained CycleGAN")
    parser.add_argument("--data_root", type=str, default="data/raw", help="Path to dataset")
    parser.add_argument("--num_samples", type=int, default=5, help="Number of samples to visualize")
    parser.add_argument("--output", type=str, default="cyclegan_visual_audit.png", help="Output filename")
