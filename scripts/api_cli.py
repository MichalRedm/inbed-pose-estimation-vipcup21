...
def start_training(run_id, config_path, remote):
    payload = {"run_id": run_id, "config_path": config_path, "remote": remote}
    try:
...
def main():
    ...
    if args.command == "start":
        start_training(args.run_id, args.config, args.remote)
